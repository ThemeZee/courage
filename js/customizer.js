...
( function( $ ) {
	...
	/* Theme Colors */
	wp.customize( 'courage_theme_options[widget_title_color]', function( value ) {
	...
	wp.customize( 'courage_theme_options[widget_link_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'courage_theme_options[footer_color]', function( value ) {
		value.bind( function( newval ) {
